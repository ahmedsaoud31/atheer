              ...
              <table class="table table-vcenter card-table">
                ...
                <tbody>
                  <tr>
                    <td >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/006m.jpg)"></span>
                        <div class="flex-fill">
                  ...
                  <tr>
                    <td >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/004f.jpg)"></span>
                        <div class="flex-fill">
                  ...
                  <tr>
                    <td >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/007m.jpg)"></span>
                        <div class="flex-fill">
                  ...
                  <tr>
                    <td >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/009m.jpg)"></span>
                        <div class="flex-fill">
              ...
              <table class="table table-vcenter table-mobile-md card-table">
                ...
                <tbody>
                  <tr>
                    <td data-label="Name" >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/010m.jpg)"></span>
                        <div class="flex-fill">
                  ...
                  <tr>
                    <td data-label="Name" >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/005f.jpg)"></span>
                        <div class="flex-fill">
                  ...
                  <tr>
                    <td data-label="Name" >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/006f.jpg)"></span>
                        <div class="flex-fill">
                  ...
                  <tr>
                    <td data-label="Name" >
                      <div class="d-flex py-1 align-items-center">
                        <span class="avatar me-2" style="background-image: url({{ asset('/') }}themeses/tabler/static/avatars/008f.jpg)"></span>
                        <div class="flex-fill">
              ...
              <table class="table card-table table-vcenter text-nowrap datatable">
                <thead>
                  <tr>
                    ...
                    <th class="w-1">No.
                      @include('atheer::icons.svg.chevron-up')
                    </th>
              ...
              <ul class="pagination m-0 ms-auto">
                <li class="page-item disabled">
                  <a class="page-link" href="#" tabindex="-1" aria-disabled="true">
                    @include('atheer::icons.svg.chevron-left')
                    prev
                  </a>
                </li>
                ...
                <li class="page-item">
                  <a class="page-link" href="#">
                    @include('atheer::icons.svg.chevron-right')
                  </a>
                </li>
              </ul>
            </div>
